...
fn main() {
    ...
    println!(
        "Our favourite season is {}, we have scored {} points and the event starts at {}pm. Remember a touchdown is worth {}.",
        season, points_scored, event_time, TOUCHDOWN_POINTS
    );

    println!(
        "Our favourite season is {0}, we have scored {1} points and the event starts at {2}pm. Remember a touchdown is worth {3}.",
        season, points_scored, event_time, TOUCHDOWN_POINTS
    );

    let favourite_beverage: &str = "Coke Zero";
}
